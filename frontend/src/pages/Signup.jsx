...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await api.post("/auth/register", formData); // 👈 token not attached
        ...
        <Card className="p-8 space-y-6 glass-elevated">
          ...
          <div className="space-y-4 text-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Sign in to your Global Connect account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full gradient-primary hover:gradient-primary/90 hover-lift group"
            >
              {isLoading ? (
